...
func (s *AnalyticsService) GetAuditLogPaginated(ctx context.Context, filter repository.AuditLogFilter) (*repository.AuditLogPage, error) {
	return s.repo.GetAuditLogPaginated(ctx, filter)
}
