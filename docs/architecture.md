...
## Architecture Patterns & Auditing

The backend strictly enforces Clean Architecture, SOLID principles, and idiomatic Go design patterns audited by **DPX-Go**:
- **Design Patterns & Engineering Practices Guide**: [docs/architecture/patterns-and-practices.md](architecture/patterns-and-practices.md)
- **Interactive DPX Architecture Dashboard**: [docs/reports/backend_dpx.html](reports/backend_dpx.html)
- **Full DPX Markdown Analysis**: [docs/reports/backend_dpx.md](reports/backend_dpx.md)
- **Metric Snapshot**: 0 architecture smells/violations (0 God Structs, 0 KISS Long Parameter Lists), 676 active design patterns & clean inversions.
