  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Feedback Form Builder</h1>
      ...
      {/* Form meta */}
      <Card>
        <CardHeader><CardTitle className="text-sm">Form Settings</CardTitle></CardHeader>
        <CardContent className="space-y-3">
          <div><p className="text-xs font-medium mb-1">Form Name</p><Input defaultValue="Post-Cancellation Survey" /></div>
          <div className="flex flex-wrap gap-3">
            <div><p className="text-xs font-medium mb-1">Trigger</p>
            ...
            <div><p className="text-xs font-medium mb-1">Display Delay (sec)</p><Input defaultValue="2" className="w-28 font-mono" /></div>
          </div>
        </CardContent>
      </Card>
        ...
        {questions.map((q, i) => (
          <Card key={q.id} className="border-l-4 border-l-primary">
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <CardTitle className="text-xs text-muted-foreground">Question {i + 1} · {q.type}</CardTitle>
